...
- **Design Rule Checker (DRC)**: Dynamic syntax/layout checker that warns you of short-circuits, floating/unconnected inputs, and wire loops.
...
ot / 
and / 
or / xor / xnor: Exhaustive standard logic gates.
*   uffer: High-impedance buffer and signal booster.
*   ha (Half Adder) & a (Full Adder): Core hardware arithmetic units.
*   dd4 (4-Bit Carry-Lookahead Adder): Multi-bit mathematical block.
...
*   dff / jkff / 	ff (Flip-Flops): Edge-triggered state machines.
...
### 5. Memory Modules
*   om8 (256-Byte Read-Only Memory): Features a full Hex Editor modal interface.
*   am8 (256-Byte Random Access Memory): Read/Write memory syncing on the rising edge of a clock.

### 6. Arithmetic Unit
*   lu8 (8-Bit Arithmetic Logic Unit): Supports addition, subtraction, AND, OR, XOR, SHL, SHR, and NOT operations, complete with Overflow, Underflow, and Zero flags.
